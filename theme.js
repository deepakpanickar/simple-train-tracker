...
export const styles = StyleSheet.create({
  ...
  delayBadge: { paddingHorizontal: 12, paddingVertical: 6, borderRadius: 16 },
  ...
  stationsContainer: { gap: 16 },
  stationRow: { flexDirection: 'row', alignItems: 'center' },
  stationIndicatorContainer: { alignItems: 'center', marginRight: 16 },
  stationIndicator: { width: 16, height: 16, borderRadius: 8, borderWidth: 2, alignItems: 'center', justifyContent: 'center' },
  stationLine: { width: 2, height: 32, marginTop: 4 },
  stationNameText: { fontSize: 16, fontWeight: '500' },
  ...
  simpleSearchInput: {
    ...
    borderRadius: 8, padding: 12, fontSize: 16, marginBottom: 12, // tightened
  },
  simpleList: {
    backgroundColor: COLORS.white, borderRadius: 8, borderWidth: 1,
    borderColor: '#e5e7eb', marginTop: 4, marginBottom: 8, // tightened
  },
  simpleListItem: {
    paddingVertical: 10, paddingHorizontal: 12, // tightened
